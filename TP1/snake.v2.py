...
FILAS_TABLERO = 10
COLUMNAS_TABLERO = 10
LARGO_MAX_SERPIENTE = 40 #largo para ganar. Minimo 2
SEGUNDOS_POR_MOVIMIENTO = 0.8
...
def main():
	...
	while(seguir_jugando):	
		...
		tablero, estructura_tablero = crear_tablero(posicion_serpiente)
...
def crear_tablero(posicion_serpiente):
	...
	return tablero, estructura_tablero
